         ...
         <div class="row">
            ...
            <div class="col-sm-5">
               <div class="form-group">
                  ...
                  <input name="employee_id" tabindex="1" placeholder="PRA1223" autocomplete="on" type="text" class="input-field {{ $errors->has('employee_id') ? 'invalid' : ''}}" value="{{ old('employee_id')}}">  
                  </div>
                  @error('employee_id')
                  <div>
               ...
               <div class="form-group">
                  ...
                  <div class="base-input">
                      <input name="employee_name" tabindex="3" placeholder="" autocomplete="on" type="text" class="input-field {{ $errors->has('employee_name') ? 'invalid' : ''}}" value="{{ old('employee_name')}}">  
                  </div> 
                  @error('employee_name')
                  <div>
                    <span class="text-danger">
               ...
               <div class="form-group">
                ...
                <div class="base-input">
                    <input name="mobile" tabindex="4" placeholder="" autocomplete="on" type="text" class="input-field {{ $errors->has('mobile') ? 'invalid' : ''}}" value="{{ old('mobile')}}">  
                </div>
                @error('mobile')
                <div>
                  <span class="text-danger">
            ...
            <div class="col-sm-5">
               <div class="form-group">
                  ...
                  <div class="base-input" label="employee Email">
                      <input name="employee_email" tabindex="2" placeholder="" autocomplete="on" type="text" class="input-field {{ $errors->has('employee_email') ? 'invalid' : ''}}" value="{{ old('employee_email')}}">  
                  </div>
         ...
         <div class="row">
            ...
            <div class="col-sm-5">
               ...
               <div class="form-group">
                  ...
                  <div class="base-input">
                      <input name="joiningdate" tabindex="9" placeholder="" autocomplete="on" type="text" class="input-field {{ $errors->has('joiningdate') ? 'invalid' : ''}}" id="joiningdate" value="{{ old('joiningdate')}}">  
                  </div>
                  @error('joiningdate')
                  <div>
                      <span class="text-danger">
               ...
               <div class="form-group">
                  ...
                  <textarea rows="2" cols="10" placeholder="Street 1" class="text-area-field base-text-area {{ $errors->has('address') ? 'invalid' : ''}}" tabindex="11" type="text" name="address">{{ old('address')}}</textarea>
                </div>
                @error('address')
                <div>
                    <span class="text-danger">
            ...
            <div class="col-sm-5">
              <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <div class="base-input">
                  <input name="lastdate" tabindex="10" placeholder="" autocomplete="on" type="text" class="input-field {{ $errors->has('employee_id') ? 'invalid' : ''}}" id="lastdate" value="{{ old('lastdate')}}">  
                  </div>
               </div>
               <div class="form-group">
               ...
               <div class="form-group">
                  ...
                  <div class="base-input">
                      ...
                      <option value="{{ $id }}" {{ (in_array($id,old('skills',[])) 
